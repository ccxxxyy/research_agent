...
_STOPWORDS: frozenset[str] = frozenset(
    ["的", "了", "在", "是", "我", "有", "和", "就", "不", "人", "都", "一", "一个", "上", "也", "很", "到", "说", "要", "去", "你", "会", "着", "没有", "看", "好", "自己", "这", "他", "她", "它", "们", "那", "被", "从", "把", "让", "用", "对", "为", "与", "及", "等", "但", "而", "或", "之", "其", "且", "因", "如", "所", "能", "更", "将", "已", "由", "于", "可", "以", "中", "个", "年", "月", "日", "时", "分", "万", "亿", "元", "股", "公司", "发布", "公告", "表示", "记者", "截至", "目前", "同时", "以及", "相关", "根据", "显示", "数据", "通过", "进行", "报告", "方面", "市场", "行业", "中国", "以来", "来源", "编辑", "责任", "证券", "财经", "新闻", "消息", "据悉", "获悉", "上述", "下述", "其中", "此外", "此前", "针对", "关于", "这是", "该股", "SZ", "SH"]
)
